...
public class GJVoidDepthFirst<A> implements GJVoidVisitor<A> {
    ...
    * f0 -> <INTEGER_LITERAL>
    */
   public void visit(PlainIntegerLiteral n, A argu) {
      n.f0.accept(this, argu);
   }
    ...
    * f1 -> <INTEGER_LITERAL>
    */
   public void visit(IntegerLiteralWithPosSign n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
   }
    ...
    * f1 -> <INTEGER_LITERAL>
    */
   public void visit(IntegerLiteralWithNegSign n, A argu) {
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
   }
